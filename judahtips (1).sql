...
(63, 42, 'Reginald Bossman', 22, NULL, 'In the above example, you’ll still get authors even if they don’t have a published profile. To only get authors with a published profile use matching(). If you have defined custom finders in your associations', 'read', '1499699754_184387.jpg', 'yes', '2017-07-11 20:30:24', '2017-12-06 16:18:20'),
(64, 42, 'Lizile Xulu', 22, '', '$comments = TableRegistry::get(\'Comments\');\r\n$present = (new Collection($entity->comments))->extract(\'id\')->filter()->toArray();\r\n$comments->deleteAll([\r\n    \'article_id\' => $article->id,\r\n    \'id NOT IN\' => $present\r\n]);', 'read', '1499697827_380340.jpeg', NULL, '2017-07-11 20:32:35', '2017-12-06 16:18:20'),
(59, 42, 'Lizile Xulu', 22, '', 'CakePHP 3.x: saving multiple records - Stack Overflow', 'read', '1499697827_380340.jpeg', NULL, '2017-07-11 18:44:26', '2017-12-06 16:18:20'),
(60, 22, 'Reginald Bossman', 42, '', 'Sup bra ', 'read', '1499699754_184387.jpg', NULL, '2017-07-11 18:48:38', '2017-08-02 12:05:08'),
(54, 42, 'Lizile Xulu', 22, '', 'https://stackoverflow.com/questions/.../how-to-save-array-data-in-database-in-cakeph...Jun 9, 2016 - You have assigned $user with $this->Users->newEntity(); . And afterwords you are .... Cross Validated (stats) · Theoretical Computer Science · Physics · Chemistry · Biology · Computer Science · Philosophy · more (3).', 'read', '1499697827_380340.jpeg', NULL, '2017-07-11 18:16:48', '2017-12-06 16:18:20'),
(55, 42, 'Lizile Xulu', 22, '', 'Number of years PHP Development experience Current Salary Expected Salary Notice Period Please let me know if I can go ahead and refer your profile to the client. I will send you ', 'read', '1499697827_380340.jpeg', NULL, '2017-07-11 18:17:21', '2017-12-06 16:18:20'),
...
INSERT INTO `profiles` (`id`, `firstname`, `surname`, `user_id`, `province_id`, `career_id`, `mobile`, `email`, `gender`, `birth_date`, `drivers_lic`, `created`, `modified`) VALUES
(9, 'Reginald', 'Bossman', 22, 1, 2, '0784450831', 'reggiestain@gmail.com', 'Male', '04/19/2017', 'Yes', '2017-04-16 22:17:58', '2017-04-22 13:59:46'),
(11, 'Reggie', 'Stain', 36, 1, 1, '0784450830', 'reggiestain15@gmail.com', 'Male', '04/13/2017', 'No', '2017-04-23 13:17:16', '2017-05-11 16:57:19'),
(12, 'mosima', 'rasesemola', 37, 4, 4, '0796074680', 'mosimaofficial@gmail.com', 'Female', '02/08/1990', NULL, '2017-05-08 19:54:40', '2017-05-08 19:54:40'),
(17, 'Lizile', 'Xulu', 42, 4, 1, '0745455558', 'xulu.lizile@gmail.com', 'Male', '05/30/2017', NULL, '2017-05-11 10:59:02', '2017-05-11 10:59:02'),
(19, 'Riley', 'Bossman', 43, 2, 3, '0815483075', 'riley@gmail.com', 'Male', '07/26/2017', NULL, '2017-07-27 19:45:46', '2017-07-27 19:45:46');
...
(22, 'Reginald', 'Bossman', 'reggiestain@gmail.com', '', '$2y$10$tK3qLmIn3jlmhntyu2tWF./Ne.LID2esI37TOIW87o/O26HRmycXa', 1, 'active', '1499699754_184387.jpg', '2017-04-16 22:17:58', '2017-07-10 15:15:54'),
