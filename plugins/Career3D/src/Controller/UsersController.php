...
class UsersController extends AppController {
    ...
    public function resetpass() {
        if ($this->request->is('ajax')) {
            if ($this->request->is('post')){
                ...
                $status = 'error';
                $message = 'The email address you entered is not registered, please enter a valid email.';
            }
            }
    ...
    public function resetlink($id,$hash) {        
        $result = $this->reset_verify($id,$hash);
        $res = $this->get_profile($hash);
        if($result == true){
    ...
    public function dashboard() {
        ...
        /*  $Version = new \Facebook\Facebook([
          'app_id' => '286929131734235',
          'app_secret' => '9d1db92f7a6e179b8bfc72abb1c6af16',
