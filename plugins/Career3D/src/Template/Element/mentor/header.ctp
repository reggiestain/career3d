                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">                            
                          <?php echo $this->Html->image('Career3D.mentor/user3-128x128.jpg',['class'=>'img-circle','alt'=>"User Image"]);?>
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">                            
                            <?php echo $this->Html->image('Career3D.mentor/user4-128x128.jpg',['class'=>'img-circle','alt'=>"User Image"]);?>                         
                          </div>
                          <h4>
                            Developers
