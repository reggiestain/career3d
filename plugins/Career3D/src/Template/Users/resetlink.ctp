    ...
    <div class="container">
        ...
        <div class="row overflownone">
            <div class="col-md-4 ">
                ...
                <div class="upass-alert"></div>        
                    <?php echo $this->Form->create($users, ['id' => 'upass-form', 'url' => ['controller' => 'pages', 'action' => 'resetpass']]); ?>
                    <div class="form-group">
                        ...
                        <?php echo $this->Form->input('user_id',['value'=>$resId,'type'=>'hidden']);?>
                    </div>
                    <div class="form-group">
...
<script>
    $(document).ready(function () {
        ...
        $('#login-for').submit(function (event) {
            event.preventDefault();
        ...
        $('#upass-form').submit(function (event) {
            event.preventDefault();
            var formData = $(this).serialize();
            var url = $(this).attr("action");
            $.ajax({
