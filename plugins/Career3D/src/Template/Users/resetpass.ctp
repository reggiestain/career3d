...
if($status === '300'){
  ...
  echo "<div class='alert-div alert alert-success fade in alert-dismissable lead'>"
          . "<a class='close' href='#' data-dismiss='alert' aria-label='close' title='close'>×</a>"
          . "<strong>Success! </strong>". $message."</div>"; 
} else if($status === 'error'){
    
      echo "<div class='alert-div alert alert-warning fade in alert-dismissable lead'>"
          . "<a class='close' href='#' data-dismiss='alert' aria-label='close' title='close'>×</a>"
