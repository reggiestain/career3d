...
<ul class="comments-list">
    <li class="comment">
        ...
        <div class="comment-body">
            ...
            <div>
                <a href="#" class="like-reply" data="<?php echo $comment->post_id;?>" id="<?php echo $comment->id;?>"><?php echo count($comment->comment_likes);?> Like</a>&nbsp;|&nbsp;<a href="#" class="write-reply" data="<?php echo $comment->id;?>" id="reply<?php echo $comment->id;?>"><?php echo count($comment->comment_replies);?> Reply</a> 
            </div>
        </div>
...
<div class="input-group"> 
    <input class="form-control" placeholder="comment...." name="comment<?php echo $comment->post_id;?>" type="text">
    <span class="input-group-addon">
        <a href="#"><i class="fa fa-edit"></i></a>  
    </span>                        
</div>
<div class="form-group" style="margin-top:4px">
    <button class="btn btn-primary btn-sm post-comm" id="<?php echo $comment->post_id;?>">Post</button>
</div>